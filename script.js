...
async function searchHeros(textSearched) {
  ...
  await fetch(
    `https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${textSearched}&apikey=9ab871748d83ae2eb5527ffd69e034de&hash=d35377547e551cd64a60657d2517bb7f?ts=1`
  )
...
(function () {
  ...
  if (currentTheme == null) {
    ...
    themeButton.style.backgroundColor = "#050a30";
  ...
  switch (currentTheme) {
    ...
    case "dark":
      ...
      themeButton.style.backgroundColor = "#018a3a";
